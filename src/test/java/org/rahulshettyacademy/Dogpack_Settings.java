...
public class Dogpack_Settings extends AndroidBaseTest {
    ...
    @Test(priority = 3, enabled = false, groups = { "Smoke", "Regression" })
    ...
    @Test(priority = 7, enabled = false, groups = { "Regression" })
    public void myReviews() throws InterruptedException {
        Setting.myReview();
    }

    /** #8 (UI #10) - "Your account" -> Love DogPack? Rate us */
    @Test(priority = 8, enabled = false, groups = { "Regression" })
    ...
    @Test(priority = 9, enabled = false, groups = { "Regression" })
     ...
     */
    @Test(priority = 10, enabled = false, groups = { "Smoke", "Regression" })
    ...
    @Test(priority = 11, enabled = false, groups = { "Regression" })
    ...
    @Test(priority = 13, enabled = false, groups = { "Smoke", "Regression" })
     ...
     */
    @Test(priority = 14, enabled = false, groups = { "Smoke", "Regression" })
    ...
    @Test(priority = 15, enabled = false, groups = { "Smoke", "Regression" })
    ...
    @Test(priority = 19, enabled = false, groups = { "Smoke", "Regression" })
    public void HapiticsFunctionality() throws InterruptedException {
        Setting.Hapitics();
    }

    /** #20 (UI #20) - Units (Km->Mi then Mi->Km) */
    @Test(priority = 20, enabled = false, groups = { "Smoke", "Regression" })
    ...
    @Test(priority = 21, enabled = false, groups = { "Smoke", "Regression" })
    ...
    @Test(priority = 23, enabled = false, groups = { "Regression" })
    ...
    @Test(priority = 24, enabled = false, groups = { "Regression" })
